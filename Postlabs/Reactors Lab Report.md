...
theta, C_bar, N = Solver_CMFR_N(t_data, C_data, theta_guess, C_bar_guess)
#theta_guess-Estimate of time spent in one CMFR with units.
#C_bar_guess-Estimate of average concentration with units
#             (Mass of tracer)/(volume of one CMFR)
#theta-residence time in seconds
#C_bar-average concentration with same units as C_bar_guess
#N-number of CMFRS in series that best fit the data
